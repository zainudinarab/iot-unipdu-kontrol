...
async function run() {
  // Let's test the specific IR codes from the specifications:
  // To Turn ON: { code: 'PowerOn', value: '' } or { code: 'PowerOn', value: 'PowerOn' }
  // Let's test setting temperature: { code: 'T', value: 24 }
  ...
  console.log('--- TEST: Sending Temperature 24 (T: 24) ---');
  await sendCommand('a352e2e4b0b6ff61b9rf4k', [{ code: 'T', value: 24 }]);
}
