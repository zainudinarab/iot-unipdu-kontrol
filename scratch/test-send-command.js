...
async function run() {
  // Let's test toggling switch/power. We'll try sending:
  // [{ "code": "switch", "value": true }]
  // Or:
  // [{ "code": "PowerOn", "value": "" }]
  console.log('--- TEST 1: Sending switch: true ---');
  await sendCommand('a352e2e4b0b6ff61b9rf4k', [{ code: 'switch', value: true }]);
}
